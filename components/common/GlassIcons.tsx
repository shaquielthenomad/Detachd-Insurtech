...
import './GlassIcons.css'; // Import the CSS file

interface GlassIconItem {
  icon: React.ReactNode;
  color: 'blue' | 'purple' | 'red' | 'indigo' | 'orange' | 'green' | string; // Allow custom colors too
  label: string;
  customClass?: string;
...
const GlassIcons: React.FC<GlassIconsProps> = ({ items, className }) => {
  const getBackgroundStyle = (color: string) => {
    ...
    return { background: color }; // Fallback for custom colors not in mapping
  };
